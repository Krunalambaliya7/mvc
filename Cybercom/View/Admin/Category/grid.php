				...
				<tbody>
						...
						?>		
							<tr>
								...
								<td>
									<button class="btn btn-info" onclick="base.setUrl('<?php echo $this->getUrl()->getUrl('changeStatus',NULL,['id'=>$value->categoryId,'Status'=>$value->Status]); ?>').resetParams().load()"><?php echo $value->Status;?></button>
								</td>
