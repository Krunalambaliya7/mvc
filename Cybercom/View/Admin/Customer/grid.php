				...
				<tbody>
						...
						?>
							<tr>
								...
								<td>
									<button class="btn btn-info" onclick="base.setUrl('<?php echo $this->getUrl()->getUrl('changeStatus',NULL,['id'=>$value->CustomerId,'Status'=>$value->status]); ?>').resetParams().load()"><?php echo $value->status;?></button>
								</td>
