...
<div>
	...
	<form method="POST" action="<?php echo $this->getUrl()->getUrl('update','Admin\Product_Media',[]);?>">
	...
	<form method="POST" enctype="multipart/form-data" action="<?php echo $this->getUrl()->getUrl('save','admin\Product\Media',[]);?>">
