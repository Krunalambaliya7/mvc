			...
			<table class="table table-striped">
				...
				<tbody>
						...
						<?php	}
							...
							<td>
								<button class="btn btn-info" onclick="base.setUrl('<?php echo $this->getUrl()->getUrl('changeStatus',NULL,['id'=>$value->ProductId,'Status'=>$value->Status]); ?>').resetParams().load()"><?php echo $value->Status;?></button>
							</td>
